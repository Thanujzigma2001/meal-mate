                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <div class="carousel-caption d-flex flex-column justify-content-end">
                                            <h1>be a Meal Mate</h1>
                                            
                                            <p>Welcome to Meal Mate,<br> where we believe that no student should ever go hungry. </p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carousel-caption d-flex flex-column justify-content-end">
                                            ...
                                            <p>To provide nutritious meals to needy students.</p>
                                        </div>
                                    </div>
                                    ...
                                    <div class="carousel-item">
                                        ...
                                        <div class="carousel-caption d-flex flex-column justify-content-end">
                                            ...
                                            <p>Join us in making a difference<br> in the lives of these young individuals<br> and building a stronger, healthier community together.</p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-10 col-12 text-center mx-auto">
                            <h2 class="mb-5">Welcome to Meal Mate Charity</h2>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="custom-text-box">
                                ...
                                <h5 class="mb-3">Meal-Mate, Non-Profit Organization</h5>

                                <p class="mb-0">Our concept of,Meal Mate, was founded with a simple yet powerful mission: to combat hunger and do support the educational success of students in need. We understand that hunger should never be a barrier to learning, and we are committed to providing nutritious meals to those who need it most.

With a team of dedicated volunteers and the support of generous donors and community partners, we work tirelessly to ensure that no student in our community goes hungry. Our programs not only fill empty stomachs but also provide vital support for academic achievement and overall well-being.

At Meal Mate, we believe in the transformative power of food and education. By nourishing bodies and minds, we empower students to reach their full potential and break the cycle of poverty. Join us in our mission to create a brighter future for every student, one meal at a time.</p>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-12">
                                    <div class="custom-text-box mb-lg-0">
                                        ...
                                        <p> Our mission is to provide nutritious meals to needy students</p>

                                        <ul class="custom-list mt-2">
                                            <li class="custom-list-item d-flex">
                                                <i class="bi-check custom-text-box-icon me-2"></i>
                                                Foods for the neeedy
                                            </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-5 col-md-7 col-12">
                            <div class="custom-text-block">
                                <h2 class="mb-0">Piyumi Buddhakorala</h2>

                                <p class="text-muted mb-lg-4 mb-md-4">Co-Founding Partner</p>

                                <p>1.We Started Meal Mate with following objectives<br>
                                    Ensuring that all members of the university community have access to nutritious meals.<br> 
2.Offer balanced and nutritious meal options at affordable prices thereby supporting the<br> 
overall health and well-being of individuals within the university.<br>
iii.Fostering a sense of community and belonging.<br>
iv.Provide fuel for learning by offering meals.<br>
v.Mitigate the financial strain associated with meal expenses for individuals.<br></p>

                                <p>
vi.Encourage active participation and feedback from members of the university community<br> 
and ensure that it meets their needs and preferences effectively.<br>
vii.Establish mechanisms for ongoing evaluation and improvement of the meal providing <br>
procedure based on feedback, data analysis and changing needs within the university<br> 
community.<br></p>
                ...
                <div class="container">
                    <div class="row justify-content-center align-items-center">
                        ...
                        <div class="col-lg-5 col-12 ms-auto">
                            <h2 class="mb-0">Make an impact. <br> Stop Hunger.</h2>
                        </div>

                        <div class="col-lg-5 col-12">
                            <a href="#" class="me-4">Make a donation</a>

                            <a href="#section_4" class="custom-btn btn smoothscroll">Become a Meal-mater</a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                            <div class="custom-block-wrap">
                                <img src="images/student.jpg" class="custom-block-image img-fluid" alt="">

                                <div class="custom-block">
                                    <div class="custom-block-body">
                                        <h5 class="mb-3">Provide Meal</h5>

                                        <p>We intend to provide meal to school students who face huge economical problems and malnutrition</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-12 mb-4 mb-lg-0">
                            <div class="custom-block-wrap">
                                <img src="images/uni.jpg" class="custom-block-image img-fluid" alt="">

                                <div class="custom-block">
                                    <div class="custom-block-body">
                                        <h5 class="mb-3">Provide quaality canteen facilities to students</h5>

                                        <p>We intend to provide quality and reasonable canteen facilities to students through student entrapenures within uni</p>
                        ...
                        <div class="col-lg-4 col-md-6 col-12">
                            <div class="custom-block-wrap">
                                <img src="images/elder.jpg" class="custom-block-image img-fluid" alt="">

                                <div class="custom-block">
                                    <div class="custom-block-body">
                                        <h5 class="mb-3">Provide meals to Elders</h5>

                                        <p>We are donating foods monthly to a selected elder house in the country</p>
            ...
            <section class="volunteer-section section-padding" id="section_4">
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12">
                            <h2 class="text-white mb-4">Meal-Mater</h2>

                            <form class="custom-form volunteer-form mb-5 mb-lg-0" action="#" method="post" role="form">
                                <h3 class="mb-4">Become a Meal-Mater today</h3>
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            <div class="custom-block-body text-center">
                                <h4 class="text-white mt-lg-3 mb-lg-3">About Volunteering at Meal Mate</h4>

                                <p class="text-white">A great place for you to find new friends and do your duty to the world</p>
                            </div>
                        </div>
